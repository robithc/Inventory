package com.example.ro221d.inventory;
...
import com.example.ro221d.inventory.R;
import com.example.ro221d.inventory.data.BookContract.BookEntry;
...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBookNameEditText = (EditText) findViewById(R.id.book_name_edit_text);
        mBookDescriptionEditText = (EditText) findViewById(R.id.book_description_edit_text);
        mBookPriceEditText = (EditText) findViewById(R.id.book_price_edit_text);
        mBookQuantityEditText = (EditText) findViewById(R.id.book_quantity_edit_text);
        mBookSupplierNameEditText = (EditText) findViewById(R.id.book_supplier_name_edit_text);
        mBookSupplierNumberEditText = (EditText) findViewById(R.id.book_supplier_number_edit_text);
        ...
        if (mCurrentBookUri == null) {
            ...
            mBookDescriptionEditText.setEnabled(true);
            mBookSupplierNameEditText.setEnabled(false);
            mBookSupplierNumberEditText.setEnabled(false);
    ...
    private boolean saveBook() {
        ...
        if (mCurrentBookUri == null) {
            ...
            // Otherwise this is an EXISTING book, so update it with content URI: mCurrentProductUri
